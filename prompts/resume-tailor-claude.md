...
1. **generate Resume in word**

2. **DELTA section**, including:
   * Missing skills or experiences required by the JD that are not present in my Master Resume.
   * Missing or weak quantitative metrics that could strengthen the resume.
