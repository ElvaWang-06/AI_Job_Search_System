...
**Cut in this order:**
1. Drop the least JD-relevant *entry* entirely (a whole org block, not a stray bullet)
2. Cut entries to 3 bullets, then 2 for older/less relevant roles
3. Merge two related bullets into one
